...
\section{Objective} 
A Co-op or summer internship as a software engineer where I will be able to expand my skill set and make valuable contributions. %and learn from my experience.
...
\begin{description} \itemsep -11pt
		%\item[Patent Co-author] (pending) for a hardware and software solution to account for variations in the spectra of multiple light sources in imaging applications. \\
